...
export const Series: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "name",
    defaultColumns: ["name", "author", "bookCount", "liveLink"],
    group: "Taxonomy",
    description:
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        ...
        // No target: nothing measures a series description, and an amber number
        // with no rule behind it is how editors learn to ignore amber numbers.
