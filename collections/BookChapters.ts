...
import { wordCount } from "../lib/payload/fields";
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        ...
        // No target: a chapter is as long as the chapter is. The count is here
        // for two reasons. A paste that silently dropped half the text is visible
        // immediately rather than after the next deployment; and the sidebar
        // wordCount field is hand-entered, so this is the number to put in it.
