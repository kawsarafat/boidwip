...
export const Books: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "title",
    defaultColumns: ["title", "rightsTier", "engagement", "publishDate", "_status", "liveLink"],
    group: "Catalogue",
    description:
      ...
      tabs: [
          ...
          fields: [
            {
              ...
              admin: {
                ...
                // The "thin content" the description warns about, given a number.
                // 150 words is roughly where a synopsis stops reading as a
                // scraped blurb; nothing enforces it.
                components: wordCount({
                  target: 150,
                  why: "A synopsis this short reads as a back-cover blurb, which is the thin content this field exists to avoid.",
                }),
              },
            },
            {
              ...
              admin: {
                ...
                // Higher target than the synopsis because for an in-copyright book
                // this field IS the page: there is no text, no chapters and no PDF
                // to carry it, so 400 words is the difference between a page and a
                // buy button with a paragraph over it.
                components: wordCount({
                  target: 400,
                  why: "On a Tier D book this review is the only substantial content the page has. Under ~400 words the page is a buy button with a caption.",
                }),
              },
            },
            {
              ...
              admin: {
                ...
                // No target: two or three sentences is the instruction, and a word
                // quota on it would push editors to pad exactly the field whose
        ...
        /* ---------------- Performance: what happened next ---------------- */
        {
          ...
          fields: [
            ...
            // The second list-only column, here rather than at top level so the
            // two sit together and the reason above covers both.
            liveLinkField,
          ],
        },
      ],
