...
export const Authors: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "name",
    defaultColumns: ["name", "deathYear", "bookCount", "featured", "liveLink"],
    group: "Taxonomy",
    description:
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                ...
                // The 100 in that sentence, made checkable while writing rather
                // than after publishing. Same number as isThinEntityPage().
                components: wordCount({
                  target: 100,
                  why: "Under 100 words AND fewer than 2 books ships the author page as noindex and keeps it out of the sitemap.",
                }),
              },
            },
            {
