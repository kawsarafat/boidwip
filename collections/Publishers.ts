...
export const Publishers: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "name",
    defaultColumns: ["name", "permissionStatus", "bookCount", "liveLink"],
    group: "Taxonomy",
    description:
        ...
        /* ---------------- Profile ---------------- */
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                description: "প্রকাশনীর পরিচিতি — পেজটিকে thin হওয়া থেকে বাঁচায়।",
                // Publishers have no bio, so this description IS the length the
                // thin-page gate reads (isThinEntityPage, via htmlWordCount).
                components: wordCount({
                  target: 100,
                  why: "Under 100 words AND fewer than 2 books ships the publisher page as noindex and keeps it out of the sitemap.",
                }),
              },
            },
            {
