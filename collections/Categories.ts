...
export const Categories: CollectionConfig = {
  ...
  admin: {
    useAsTitle: "name",
    defaultColumns: ["name", "parent", "order", "featured", "liveLink"],
    group: "Taxonomy",
    description:
  ...
  fields: [
    ...
    },
    {
      ...
      admin: {
        ...
        // The ~150 above, measured while writing. No noindex gate applies to
        // category pages, so this target is the ranking claim in the line above
        // and the tooltip says exactly that rather than implying a hard rule.
        components: wordCount({
          target: 150,
          why: "A genre page competes on its introduction; under ~150 words it is a grid of covers with a heading.",
        }),
      },
    },
    {
